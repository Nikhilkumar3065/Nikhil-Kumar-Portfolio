...
const ExperienceCard = ({ exp }) => (
  <div 
    data-aos="fade-up"
    className="bg-black/25 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:bg-black/35 hover:shadow-[0_20px_50px_rgba(245,158,11,0.15)] hover:border-amber-500/20 transition-all duration-500 max-w-4xl mx-auto"
  >
    <div className="flex flex-col md:flex-row gap-8 justify-between">
      ...
      <div className="flex-1 md:border-r md:border-white/10 md:pr-8">
        ...
        <p className="text-amber-400 text-lg font-black tracking-wide mb-6 uppercase">
          {exp.organization}
        </p>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {exp.tech.map((t) => (
              <span 
                key={t}
                className="px-3 py-1.5 text-xs font-mono font-bold text-white bg-white/5 rounded-full border border-white/10 hover:bg-amber-500/20 hover:border-amber-500/30 transition-all cursor-default"
              >
                {t}
              </span>
            ))}
...
const Experience = () => {
  return (
    <section id="experience" className="bg-[#f59e0b] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-amber-950 text-base md:text-lg font-bold max-w-lg mx-auto">
            My professional training, code practice, and backend development experience.
          </p>
        </div>
